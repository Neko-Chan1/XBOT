...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("xbotg.modules." + module_name)
        ...
        if len(args) >= 1:
            ...
            buttons = InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="✨ Add Me To Your Group ✨", url="https://t.me/NakanoMiku_Xbot?startgroup=new")],
                 [InlineKeyboardButton(text="⚙️ Help", url="https://t.me/NakanoMiku_xbot?start=help"), InlineKeyboardButton(text="join Animlover group", url="https://t.me/animegrupindo?connect=connect")],
