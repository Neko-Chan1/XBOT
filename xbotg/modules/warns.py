...
from xbotg import dispatcher, BAN_STICKER, WHITELIST_USERS, SARDEGNA_USERS
...
from xbotg.modules.helper_funcs.extraction import extract_text, extract_user_and_text, extract_user
from xbotg.modules.helper_funcs.filters import CustomFilters
from xbotg.modules.helper_funcs.misc import split_message
from xbotg.modules.helper_funcs.string_handling import split_quotes
from xbotg.modules.log_channel import loggable
from xbotg.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        message.bot.send_sticker(chat.id, BAN_STICKER)  # XBOT's sticker
        keyboard = []
        log_reason = (
