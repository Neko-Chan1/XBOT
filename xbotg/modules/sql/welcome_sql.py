...
from xbotg.modules.helper_funcs.msg_types import Types
from xbotg.modules.sql import SESSION, BASE

DEFAULT_WELCOME = 'Halo {first}, bagaimana kabarmu?'
DEFAULT_GOODBYE = 'Selamat tinggal {first}, semoga tenang di alam sana :)!'
