...
from xbotg import dispatcher, WHITELIST_USERS, SARDEGNA_USERS, SUPPORT_USERS, SUDO_USERS, DEV_USERS, OWNER_ID
from xbotg.modules.helper_funcs.chat_status import whitelist_plus, dev_plus, sudo_plus
from xbotg.modules.helper_funcs.extraction import extract_user
from xbotg.modules.log_channel import gloggable

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), 'xbotg/elevated_users.json')
...
nations = """ XBOT has bot access levels we call as *"Nation Levels"* just like Kigyo
...
Owner has complete bot access, including bot adminship in chats XBOT is at.
\n*Royals* - Have super user access, can gban, manage Nations lower than them and are admins in XBOT.
\n*Sakuras* - Have access go globally ban users across XBOT.
...
\n*Disclaimer*: The Nation levels in XBOT are there for troubleshooting, support, banning potential scammers.
Report abuse or ask us more on these at [XBOT Support](https://t.me/XBOT_SUPPORT).
"""
...
__help__ = """
 ...
 You can visit @XBOT_SUPPORT to query more about these.
"""
