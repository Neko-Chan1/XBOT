...
from xbotg.__main__ import (
    ...
    CHAT_SETTINGS,
    USER_SETTINGS)
from xbotg.modules.helper_funcs.chat_status import sudo_plus, dev_plus
...
def load(_bot: Bot, update: Update):
    ...
    try:
        imported_module = importlib.import_module("xbotg.modules." + text)
    except Exception:
...
def listmodules(_bot: Bot, update: Update):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("xbotg.modules.", 1)[1]
