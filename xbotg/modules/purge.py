...
from xbotg.modules.helper_funcs.telethn.chatstatus import user_is_admin
from xbotg.modules.helper_funcs.telethn.chatstatus import can_delete_messages
from xbotg.lyn import xbotgbot


@xbotgbot(pattern="^/purge")
