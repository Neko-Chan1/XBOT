...
from xbotg import dispatcher, AI_API_KEY, OWNER_ID
import xbotg.modules.sql.chatbot_sql as sql
from xbotg.modules.helper_funcs.chat_status import user_admin
...
__help__ = """
Chatbot utilizes the CoffeeHouse API and allows XBOT to talk back making your chat more interactive.
...
Commands: These only work for XBOT Staff users.
